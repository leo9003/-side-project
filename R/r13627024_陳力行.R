log_file <- "/Users/coco/Desktop/台大計量/R/r13627024_陳力行.log"
sink(log_file, append = TRUE,split = TRUE)

# Q1 read data
install.packages("readxl")
library(readxl)
file_path <- "/Users/coco/Desktop/台大計量/R/raw/112.xlsx"
...
# 受傷人數簡單回歸
simple_model <- lm(受傷人數 ~ 夜間, data = data_clean)
